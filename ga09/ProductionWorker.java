...
public class ProductionWorker extends Employee
{
	...
	*/
	...
	ProductionWorker(String name, String id, String date, int sft, double rate) throws InvalidShift,InvalidPayRate,InvalidEmployeeNumber
	{
		super(name,id,date);
		
		if(sft != 1 && sft != 2)
			throw new InvalidShift(sft);

		shift = sft;
		
		if(rate < 0)
			throw new InvalidPayRate(rate);
